...
urlpatterns = patterns('jumpserver.views',
    ...
    url(r'^get/pic/data/$', 'get_pic_data', name='jump_get_pic_data'),
    url(r'^get/site/list/$', 'get_site_list', name='jump_get_site_list'),
    url(r'^juser/', include('juser.urls')),
    url(r'^jasset/', include('jasset.urls')),
    url(r'^jlog/', include('jlog.urls')),
    url(r'^jperm/', include('jperm.urls')),
    url(r'^jauto/', include('jauto.urls')),
    url(r'^jrelease/', include('jrelease.urls')),
    url(r'^jnginx/', include('jnginx.urls')),
)
