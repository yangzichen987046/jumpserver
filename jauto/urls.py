...
from jauto.views import *

urlpatterns = patterns('jauto.views',
                       # Examples:
                       ...
                       url(r'^program/add/$', 'program_add', name='program_add'),
                       url(r'^program/status/$', 'program_status', name='program_status'),
                       url(r'^update/install/status/$', 'update_install_status', name='update_install_status'),
                       url(r'^program/list/$', 'program_list', name='program_list'),
                       url(r'^program/list/add/$', 'program_list_add', name='program_list_add'),
                       url(r'^program/list/edit/$', 'program_list_edit', name='program_list_edit'),
                       url(r'^get/asset/list/$', 'get_asset_list', name='auto_get_asset_list'),
                       url(r'^program/status/$', 'program_status', name='auto_program_status'),
                       )
