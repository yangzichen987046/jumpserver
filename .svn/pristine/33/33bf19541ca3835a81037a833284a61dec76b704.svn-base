...
class Add_Sshkey(models.Model):
    usergroup_id = models.CharField(max_length=11, unique=True)
    host_id = models.CharField(max_length=30, unique=True)
    host_ip = models.CharField(max_length=30, unique=True)
    add_time = models.CharField(max_length=30, unique=True)
