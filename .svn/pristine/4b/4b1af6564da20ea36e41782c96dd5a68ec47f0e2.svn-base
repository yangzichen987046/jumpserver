...
urlpatterns = patterns('juser.views',
                       ...
                       url(r'^akey/list/$', 'akey_list', name='user_akey_list'),
                       url(r'^akey/add/$', 'akey_add', name='user_akey_add'),
                       url(r'^akey/edit/$', 'akey_edit', name='user_akey_edit'),
                       url(r'^akey/del/$', 'akey_del', name='user_akey_del'),
                       url(r'^func/test/$', 'func_test', name='user_func_test'),
                       )
