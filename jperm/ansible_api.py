...
class MyTask(MyRunner):
    ...
    def program_install(self, shell):
        """
        install
        """
        module_args = shell
        # module_args = '/tmp/shell/install/apache2.4_php5.6.12_install.sh 10.10.10.66 d485bf4c3987de5e19d5a74131d128cd'
        # module_args = '/tmp/shell/aa.sh 22'
        self.run("shell", module_args, become=True)
        return self.results

    def code_release(self, shell):
        """
        install
        """
        module_args = shell
