...
#CONFIGSECTION = {"accesskeyid":"XKlVo9bqlwQsh3Rr", "accesskeysecret":"oWGYAoiNEXZlSB8fTpbbYqFOb9Mayj"}
cmdlist = '''
Instance
...
def compose_url(user_params):
    ...
    parameters = {'Format':'JSON','Version':'2014-05-26','AccessKeyId':access_key_id,'SignatureVersion':'1.0','SignatureMethod':'HMAC-SHA1','SignatureNonce':str(uuid.uuid1()),'Timestamp':timestamp}
...
def setup_credentials():
    ...
    try:
        ...
        #access_key_id = CONFIGSECTION['accesskeyid']
        #access_key_secret = CONFIGSECTION['accesskeysecret']
    except Exception, e:
