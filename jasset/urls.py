...
urlpatterns = patterns('',
    ...
    url(r'^group/relation/$', group_relation, name='asset_group_relation'),
    url(r'^group/edit/$', group_edit, name='asset_group_edit'),
    url(r'^group/relation/edit$', group_relation_edit, name='asset_group_relation_edit'),
    url(r'^group/relation/add$', group_relation_add, name='asset_group_relation_add'),
    ...
    url(r'^get/asset/list/$', get_asset_list, name='asset_get_asset_list'),
    url(r'^start/asset/$', start_asset, name='asset_start_asset'),
    url(r'^stop/asset/$', stop_asset, name='asset_stop_asset'),
    url(r'^restart/asset/$', restart_asset, name='asset_restart_asset'),
    url(r'^list/update/$', list_update, name='asset_list_update'),
    url(r'^sys/init/$', sys_init, name='asset_sys_init'),
)